...
public class GolemChaseState : StateMachineBehaviour
{
    NavMeshAgent agent;
    Transform player;
    ...
    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        {
            SoundManager.Instance.EnemySource.clip = SoundManager.Instance.GolemChase;
            SoundManager.Instance.EnemySource.PlayDelayed(3f);
